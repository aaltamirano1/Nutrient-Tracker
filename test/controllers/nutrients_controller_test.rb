...
class NutrientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nutrient" do
    assert_difference('Nutrient.count') do
      post nutrients_url, params: { nutrient: { goal: @nutrient.goal, moreOrLess: @nutrient.moreOrLess, name: @nutrient.name, user_id: @nutrient.user_id } }
    end
  ...
  test "should update nutrient" do
    patch nutrient_url(@nutrient), params: { nutrient: { goal: @nutrient.goal, moreOrLess: @nutrient.moreOrLess, name: @nutrient.name, user_id: @nutrient.user_id } }
